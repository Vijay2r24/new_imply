        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {processes.map((process, idx) => (
            ...
            >
              ...
              <div className="relative bg-background rounded-2xl p-8 shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-2 h-full min-h-[280px] flex flex-col">
                {/* Step Number */}
                ...
                <div className="w-16 h-16 rounded-xl bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 transition-colors flex-shrink-0">
                  <process.icon className="w-8 h-8 text-accent" />
                </div>
                
                <h3 className="font-serif text-xl font-bold text-foreground mb-3 flex-shrink-0">
                  {process.title}
                </h3>
