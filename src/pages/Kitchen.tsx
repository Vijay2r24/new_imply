...
import { ArrowRight, ChefHat, Utensils, Refrigerator } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="font-serif text-3xl sm:text-4xl lg:text-6xl font-bold text-foreground mb-6">
              Modular{" "}
              <span className="text-accent">Kitchens</span>
            </h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Transform your cooking space with our world-class modular kitchens that combine functionality, style, and innovation.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: "Smart Storage",
                description: "Innovative storage solutions that maximize space and organization"
              },
              {
              ...
              },
              {
                ...
                description: "Seamless integration with latest kitchen appliances"
              }
            ].map((feature, idx) => (
