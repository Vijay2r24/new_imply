...
import { ArrowRight, Leaf, Recycle, Droplets, Wind, FileText, Lightbulb, Package } from "lucide-react";
...
const KitchenEco = () => {
  ...
  const specifications = [
    ...
    "100% recyclable materials used throughout",
    "Water-saving fixtures and fittings",
    "Environmentally safe coatings and finishes",
  ...
  const concepts = [
    ...
    "Green materials meet modern design",
  ...
  const components = [
    "Bamboo or reclaimed wood cabinets",
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[60vh] flex items-center pt-24 pb-12 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mx-auto">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 mb-6 bg-sage/20 backdrop-blur-sm border border-sage/30 text-sage rounded-full text-sm font-medium">
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed">
              Sustainable luxury for the environmentally conscious. Our Eco Kitchen collection combines green materials with stunning design.
            </p>
        ...
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-6">
              Eco-Friendly{" "}
              <span className="bg-gradient-to-r from-sage via-sage-light to-sage bg-clip-text text-transparent">
                {tabs.find(t => t.id === activeTab)?.label}
              </span>
            </h2>
            <p className="text-muted-foreground text-lg">
              {activeTab === "specifications" && "Committed to sustainability without compromising on quality"}
              {activeTab === "concepts" && "Explore the eco-conscious design philosophy"}
              {activeTab === "components" && "Sustainable components for a greener future"}
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {concepts.map((concept, idx) => (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: idx * 0.1 }}
                  className="p-8 rounded-3xl bg-gradient-to-br from-sage/10 to-sage-light/10 border border-sage/20 shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-2"
                >
      ...
      {/* CTA Section */}
      <section className="py-20 md:py-24 bg-gradient-to-br from-sage to-sage-dark relative overflow-hidden">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto text-center relative z-10">
          ...
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Join the sustainable living movement with our eco-friendly kitchen solutions
          </p>
