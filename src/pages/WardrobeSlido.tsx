...
import { ArrowRight, CheckCircle, Maximize2, Lock, Sparkles, FileText, Lightbulb, Package } from "lucide-react";
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed">
              Experience the perfect blend of style and functionality with our Slido sliding wardrobe collection. Designed for modern living spaces.
            </p>
        ...
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              {activeTab === "specifications" && "Discover what makes our Slido wardrobe collection exceptional"}
              {activeTab === "concepts" && "Explore the design philosophy behind Slido wardrobes"}
              {activeTab === "components" && "Premium components that make up our Slido wardrobe"}
            </p>
          </div>
